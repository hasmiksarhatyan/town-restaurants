...
public interface EventApi {
            ...
            value = {
                    ...
                    @ApiResponse(
                            ...
                            content = @Content(
                                    mediaType = APPLICATION_JSON_VALUE,
                                    schema = @Schema(implementation = ApiError.class)))})
    ResponseEntity<EventOverview> create(EventRequestDto eventRequestDto);

    @Operation(
            summary = "Get events by restaurantId",
            description = "Possible error code: 4044")
    @ApiResponses(
            value = {
                    @ApiResponse(
                            responseCode = "200",
    ...
    ResponseEntity<List<EventOverview>> getByRestaurant(int id,int pageNo, int pageSize, String sortBy, String sortDir);
    ...
    ResponseEntity<Map<Integer, List<EventOverview>>> sortByRestaurant();
