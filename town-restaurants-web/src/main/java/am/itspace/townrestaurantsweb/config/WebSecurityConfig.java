...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/restaurants/*/event").permitAll()
                ...
                .antMatchers("/payments/edit/*").hasAuthority(Role.MANAGER.name())
                .antMatchers("/cards").hasAuthority(Role.MANAGER.name())
                .antMatchers("/cards/add").hasAuthority(Role.MANAGER.name())
                .antMatchers("/orders").authenticated()
                .antMatchers("/orders/*").authenticated()
                .antMatchers("/orders/delete/*").hasAuthority(Role.MANAGER.name())
                .antMatchers("/orders/edit/*").hasAuthority(Role.MANAGER.name())
